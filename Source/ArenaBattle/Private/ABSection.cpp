...
AABSection::AABSection()
{
	...
	{
		ABLOG(Error, TEXT("Faild to load staticmesh asset. : %s"), *AssetPath);
	}
...
void AABSection::SetState(ESectionState NewState)
{
	...
	case AABSection::ESectionState::BATTLE:
		...
		GetWorld()->GetTimerManager().SetTimer(SpawnItemBoxHandle, FTimerDelegate::CreateLambda([this]()-> void {
